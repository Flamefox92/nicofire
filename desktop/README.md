...
A fully private, offline, AES-256 encrypted password manager for Windows.
No cloud. No telemetry. No network calls. Everything stays on your machine.
...
Encrypted vault: `%APPDATA%\NICOFIRE\vault.json`
This file is useless without your master password.

## Backup

Settings → Export JSON. Store the backup somewhere safe — it contains your
credentials in plaintext JSON, so treat it like a secret.
